...
export default class PaymentAccountList extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <TouchableOpacity onPress={this.props.onPress} style={itemStyles.container}>
                <View style={itemStyles.line}>
                    <Text style={itemStyles.name}>{this.props.data.accountName}</Text>
                    <Text style={itemStyles.name}>{this.props.data.accountNumber}</Text>
                </View>
            </TouchableOpacity>
        )
    }
