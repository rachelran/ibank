...
export default class AccountTypeList extends Component {
    constructor(props) {
        super(props);
    ...
    componentWillMount() {
        var oAccountTypeService = AllServices.AccountTypeService(B1Manager.getConnection());

        oAccountTypeService.find({}).then(res => {
            console.log(res);
            this.setState({
                data: res
            });
