...
export default class CurrencyTypeList extends Component {
    constructor(props) {
        super(props);
    ...
    componentWillMount() {
        var oCurrencyTypeService = AllServices.CurrencyService(B1Manager.getConnection());

        oCurrencyTypeService.find({}).then(res => {
            console.log(res);
            this.setState({
                data: res
            });
